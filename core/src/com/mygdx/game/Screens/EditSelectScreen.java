...
public class EditSelectScreen implements Screen {
    ...
    public EditSelectScreen(MyGdxGame game, float angle, SpriteBatch batch, BitmapFont font, ShapeRenderer sr){
        this.game = game;
        this.angle = angle;
        this.batch = batch;
        this.font = font;
    ...
    public void show() {
        ...
        if(levels.length != 0) {
            ...
            tlast = (Trapez)displayedLevel.getTrapezi()[displayedLevel.getTrapezi().length-1];
    ...
    public void render(float delta) {
        ...
        if(levels.length != 0) {
            ...
            drawCenteredText("edit", 52, viewport.getWorldHeight() - 30, colorActions[0].getColor());
            ...
            drawCenteredText("length: "+levelLengthString+" seconds", 32, viewport.getWorldHeight() - 320, colorActions[0].getColor());
            drawCenteredText("music: "+displayedLevel.getSongName(), 32, viewport.getWorldHeight() - 400, colorActions[0].getColor());
        }
        else
    ...
    public float getLevelLength(){
        if(displayedLevel.getTrapezi().length == 0)
            return 0;
        return tlast.getStartDistance()/displayedLevel.getScrollSpeed();
    }
